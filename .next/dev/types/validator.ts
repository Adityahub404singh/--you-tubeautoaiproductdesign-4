...
// Validate ../../../app/dashboard/new-prompt/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/new-prompt">> = Specific
  const handler = {} as typeof import("../../../app/dashboard/new-prompt/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
